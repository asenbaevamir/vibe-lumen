...
router.get(
  ...
  (req: any, res: Response) => {
    try {
      ...
      const clientUrl = process.env.CLIENT_URL || 'https://vibe-lumen.vercel.app';
      ...
      return res.redirect(`${process.env.CLIENT_URL || 'https://vibe-lumen.vercel.app'}/auth?error=auth_failed`);
    }
  }
);
